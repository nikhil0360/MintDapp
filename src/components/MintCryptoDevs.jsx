...
function MintCryptoDevs() {
  ...
  //     functionName: "getProvenanceHash",
  //     abi: contractABIJson,
  //     params: {},
  // };

  // const provenanceHash = await Moralis.executeFunction(getProvenanceHash);
  ...
  // const mintLimit = await Moralis.executeFunction(getMintLimit);
      ...
      <div style={{ display: "flex", }}>
            ...
            <div style={styles.banner}>
              ...
              <div style={styles.text}>
                <>
                  ...
                  >
                    Collection Size: {`${totalNFTs}/${1000}`}
                    <p style={{ marginTop: "10px", width: "300px" }}>
                      <Text>
                        scroll below to see the full collection or view it on{" "}
                        <a href={`https://testnets.opensea.io/assets/mumbai/${contractAddress.toLowerCase()}/${totalNFTs}`} target={"_blank"}>opensea</a>
                        {" "}
                      </Text>
                    </p>
                  </div>
        ...
        >
          ...
          <Steps direction="vertical" size="small">
            ...
            <Step status={status} title="Assign artwork for your token" description="Links your NFT token to one of our artworks" />
